...
def test_add_transaction(conn: Connection) -> None:
    ...
    transaction = Transaction("address1", "address2", Decimal(0.1))
...
def test_get_transactions(conn: Connection) -> None:
    ...
    transaction1 = Transaction("address1", "address2", Decimal(0.1))
    transaction2 = Transaction("address2", "address3", Decimal(0.2))
    transaction3 = Transaction("address3", "address4", Decimal(0.3))
